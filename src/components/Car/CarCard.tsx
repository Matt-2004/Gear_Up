...
export function CarCard({
	...
	return (
		<Link href={`/car/${carItem.id}`} className={className}>
			<article className="group flex h-auto min-h-[22rem] w-full flex-col overflow-hidden rounded-xl bg-white shadow-sm shadow-white transition-all duration-300 hover:-translate-y-0.5 hover:shadow-sm sm:h-97.5">
