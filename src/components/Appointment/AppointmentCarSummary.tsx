...
export default function AppointmentCarSummary({
	...
	return (
		<div className="border-primary-100 sticky top-8 overflow-hidden rounded-xl border bg-white shadow-lg">
			...
			<div className="p-6">
				...
				<p className="mb-4 text-gray-600">{car.title}</p>
				<div className="border-t border-gray-200 pt-4">
					<div className="flex items-baseline gap-2">
						<span className="text-primary-600 text-2xl font-bold sm:text-3xl">
