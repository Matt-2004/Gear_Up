                ...
                <div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="rounded-xl border border-gray-200 bg-linear-to-br from-gray-50 to-white p-6 shadow-sm">
            ...
            <div className="flex gap-3">
              ...
              {currentStep < 3 ? (
                ...
                <button
                  ...
                  className="flex items-center gap-2 rounded-lg bg-linear-to-r from-green-500 to-green-600 px-5 py-2.5 font-semibold text-white shadow-md transition-all hover:from-green-600 hover:to-green-700 hover:shadow-lg"
                >
