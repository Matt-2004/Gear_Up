...
const EditCarForm = ({ initialData }: EditCarFormProps) => {
  ...
  const [changedFormState, setChangedFormState] =
    useState<Partial<FillDetailsFormState>>();
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <form onSubmit={handleSubmit} className="w-full">
          <div className="overflow-hidden rounded-2xl bg-white shadow-xl">
            ...
            {/* Footer with buttons */}
            <div className="flex w-100 border-t border-gray-200 bg-gray-50 px-6 py-4 sm:px-8 lg:px-10">
              <button
                type="button"
                onClick={() => router.back()}
