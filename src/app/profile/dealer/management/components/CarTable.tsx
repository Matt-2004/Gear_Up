              ...
              >
                <td className="whitespace-nowrap px-6 py-4">
                  <div className="flex items-center gap-4">
                    <div className="relative h-16 w-16 shrink-0 overflow-hidden  bg-gray-100 border border-gray-200">
                      {car.carImages?.[0]?.url ? (
                        <Image
                  ...
                  <div className="flex flex-col gap-1.5 text-xs text-gray-600">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      {car.transmissionType !== "Default"
                        ...
                        : "Auto"}{" "}
                      • {car.fuelType !== "Default" ? car.fuelType : "Petrol"}
                    </div>
                  </div>
                </td>
                <td className="whitespace-nowrap px-6 py-4">
                  <span
                    className={`inline-flex items-center  uppercase font-normal text-gray-500`}
                  >
                    {car.vin}
                  </span>
                </td>
                ...
                <td className="relative whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                  ...
                  {activeMenuId === car.id && (
                    <div className="animate-in fade-in zoom-in-95 absolute right-8 top-10 z-20 w-48 overflow-hidden  border border-gray-200 bg-white py-1.5 shadow-sm shadow-gray-200/50 ring-1 ring-black/5 duration-100">
                      ...
                      >
                        <Pencil className="h-4 w-4 text-gray-400 group-hover/item:text-primary-600 transition-colors" />
                        Edit Details
                      </button>
