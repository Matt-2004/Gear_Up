    ...
    <div ref={containerRef} className="relative">
      ...
      {expanded && (
        <form onSubmit={handleSubmit} className="relative">
          <div className="flex items-center rounded-xl border border-gray-200 bg-gray-50 shadow-sm transition-all focus-within:border-primary-500 focus-within:ring-2 focus-within:ring-primary-500/20">
            ...
            <input
              ...
              className="h-10 flex-1 bg-transparent px-2.5 text-sm text-gray-900 placeholder:text-gray-400 outline-none!"
            />
            {query && (
              <button
                type="button"
