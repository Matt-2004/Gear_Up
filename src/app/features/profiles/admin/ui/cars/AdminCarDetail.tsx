...
const PageHeader = () => {
  ...
  return (
    <div className="flex items-center justify-between rounded-2xl bg-white p-6 shadow-sm shadow-gray-100">
      ...
      <div className="flex items-center gap-2">
        <div className="bg-primary-50 flex items-center gap-2 rounded-lg px-3 py-2">
          <CarIcon className="text-primary-600 h-4 w-4" />
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="overflow-hidden rounded-2xl bg-white shadow-sm shadow-gray-100">
        <div className="p-6">
          <h2 className="mb-4 flex items-center gap-2 text-xl font-bold text-gray-900">
            <Package className="text-primary-600 h-5 w-5" />
            Car Images
          </h2>
      ...
      <div className="overflow-hidden rounded-2xl bg-white shadow-sm">
        <div className="from-primary-50 to-primary-100 border-b border-gray-100 bg-linear-to-r p-6">
        ...
        <div className="p-6">
          <div className="grid gap-6 sm:grid-cols-2">
            <InfoCard label="Status" icon={<Clock className="h-4 w-4" />}>
              <StatusUI status={carData.status as Status} />
            </InfoCard>
      ...
      <div className="overflow-hidden rounded-2xl bg-white shadow-sm">
        <div className="from-primary-50 to-primary-100 border-b border-gray-100 bg-linear-to-r p-6">
          <h2 className="flex items-center gap-2 text-xl font-bold text-gray-900">
            <FileCheck className="text-primary-600 h-5 w-5" />
            Additional Details
          </h2>
        </div>
      ...
      {/* Action Buttons */}
      <div className="flex items-center justify-end gap-4 rounded-2xl bg-white p-6 shadow-sm shadow-gray-100">
        <RejectButton
          id={carData.id}
    ...
    <div className="overflow-hidden rounded-2xl bg-white shadow-sm">
      ...
      <div className="p-6">
        <textarea
          ...
          className="focus:border-primary-500 focus:ring-primary-200 h-48 w-full rounded-xl border-2 border-gray-200 bg-gray-50 p-4 text-gray-900 transition-all placeholder:text-gray-400 focus:bg-white focus:ring-2 focus:outline-none"
      ...
      <div className="p-6">
        <div className="flex gap-4">
          <div className="flex flex-col items-center">
            ...
            <div className="from-primary-200 mt-2 h-full w-0.5 bg-linear-to-b to-transparent" />
          </div>
