...
type ProfileState = {
  input: UserModel | undefined;
  originalInput: UserModel | undefined;
              ...
              <div className="relative flex flex-col items-center gap-3">
                ...
                <div className="group relative">
                  <Image
                    src={
                      profileState.avatarPreview ??
                      profileState.input?.profileImage ??
                      "/default_profile.jpg"
                    }
                    alt={profileState.input?.displayName ?? "Avatar"}
                    width={100}
                    height={100}
              ...
              <div className="mb-6 grid grid-cols-1 gap-5 lg:grid-cols-2">
                <Field>
                  ...
                  <Input
                    type="text"
                    name="displayName"
                    value={profileState.input?.realName ?? ""}
                ...
                <Field>
                  ...
                  <Input
                    type="text"
                    name="username"
                    value={profileState.input?.displayName ?? ""}
                ...
                <Field>
                  ...
                  <Input
                    type="tel"
                    name="phoneNumber"
                    value={profileState.input?.phone ?? ""}
