...
export async function generateMetadata(
  ...
  try {
    ...
    return {
      title: carData ? `${carData.make} ${carData.model} ${carData.year} - Gear Up` : "Car Details - Gear Up",
      description: carData ? `${carData.title} - ${carData.description?.substring(0, 150)}` : "View car details on Gear Up",
    };
  } catch {
    return {
