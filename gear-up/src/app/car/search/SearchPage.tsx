...
import { CarCursorDTO, ICar } from "@/app/types/car.types";
...
export default function SearchPage({ query, searchResults: initialData, error: initialError }: SearchPageProps) {
    ...
    const { data, fetchNextPage, hasNextPage, isFetchingNextPage, isLoading, error } = useInfiniteQuery<CarCursorDTO,
        Error,
        ...
        string | undefined>({
            ...
            queryFn: async ({ pageParam }) => {
                const response = await searchCarWithQuery(`query=${query}${pageParam ? `&cursor=${pageParam}` : ""}`);
    ...
    return (
        <div className="min-h-screen ">
            <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                {/* Search Header */}
                <div className="mb-8">
                    <h1 className="text-3xl font-bold text-gray-900 mb-4">Search Cars</h1>
                    ...
                    <form onSubmit={handleSearch} className="relative">
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                className="flex-shrink-0 p-3 rounded-lg bg-white border border-gray-300 hover:bg-gray-50 transition-colors shadow-sm"
                                aria-label="Go back"
                            >
                            ...
                            <div ref={searchContainerRef} className="relative flex-1">
                                <input
                                    ...
                                    className="w-full rounded-lg bg-white border border-gray-300 py-3 pl-12 pr-12 text-base text-gray-900 placeholder-gray-500 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500 shadow-sm"
                                />
                                ...
                                {showSuggestions && suggestions.length > 0 && (
                                    <div className="absolute z-50 mt-2 w-full rounded-lg bg-white border border-gray-200 shadow-lg max-h-60 overflow-y-auto">
                            ...
                            <button
                                type="submit"
                                className="bg-primary-600 hover:bg-primary-700 text-white font-semibold px-8 py-3 rounded-lg shadow-sm transition-colors"
                            >
                                Search
                            </button>
                        </div>
                ...
                {initialError || error ? (
                    <div className="flex flex-col items-center justify-center py-16">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 mb-6">{initialError || (error as Error)?.message || "An error occurred"}</p>
                            <button
                            ...
                            <div className="flex flex-col items-center justify-center py-16">
                                <div className="text-center">
                                    ...
                                    <p className="text-gray-600 mb-6">
                                        We couldn't find any cars matching "{query}". Try different keywords.
                                    </p>
                                    <button
                                        onClick={handleClearSearch}
                                        className="bg-primary-600 hover:bg-primary-700 text-white font-semibold px-6 py-2 rounded-lg transition-colors"
