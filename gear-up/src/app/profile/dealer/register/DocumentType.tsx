...
const DocumentType: React.FC<DocumentTypeProps> = ({ selectedType, onSelect }) => {
    return (
        <div className="bg-gray-800 rounded-xl p-8 max-w-2xl w-full">
            <h3 className="text-2xl font-bold mb-3 text-white">Select Document Type</h3>
            <p className="text-gray-400 mb-6">Choose the type of identification document you'll be uploading</p>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <h4 className="text-lg font-semibold text-white">{doc.label}</h4>
