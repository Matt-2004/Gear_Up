				...
				<div className="flex items-center justify-between gap-4">
					<button
						...
						className={clsx("rounded-xl px-6 py-3 font-medium transition-all duration-200 border-2",
							step === 1 || isSubmitting
								...
								: "bg-white text-gray-700 cursor-pointer border-gray-100 hover:border-gray-200 shadow-sm ",)}
					>
					...
					<button
						...
						className={clsx(
							...
							isButtonDisabled
								? "bg-gray-300 text-gray-500 cursor-not-allowed border-gray-300 shadow-sm"
