...
interface ICommentContext {
    ...
    handleComment: (newComment: CommentData | CommentData[], parentCommentId: string | null) => void
        ...
        const insertReplies = (
            ...
            const next = list.map((item) => {
                if (item.id === parentId) {
                    ...
                    return {
                        ...item,
                        replies: item.replies ? [...normalized, ...item.replies] : [...normalized],
                    }
                }

                if (item.replies && item.replies.length > 0 && currentLevel < MAX_LEVEL) {
