      ...
      <div className="lg:flex lg:justify-between">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            {type === "register" && (
              <div className="flex w-full justify-between">
                <input
                  {...register("firstName")}
                  className="outline-none w-[45%] border-b placeholder:text-[12px] py-2 placeholder:pl-2"
                  type="text"
            ...
            <>
              <input
                {...register("email")}
                className="outline-none w-full border-b placeholder:text-[12px] py-2 placeholder:pl-2"
                type="email"
                placeholder="Email"
                required
              />
            ...
            <button
              ...
              disabled={loading}
              className="w-full cursor-pointer main-color-gradient py-3 font-medium text-lg flex justify-center gap-4"
            >
              {loading && <Spinner />}
        ...
        <div className="lg:w-[50%] hidden lg:block   py-16 px-6">
          <Image
            ...
            width={500}
            height={100}
            className="mt-10 mr-[-50px] mx-auto"
          />
          <h2 className="text-2xl font-medium italic w-80 leading-relaxed">
...
function Checkbox(type: { type: "register" | "login" }) {
  return (
    <div className="flex items-center">
      ...
      {type.type === "register" && (
        <>
          <input type="checkbox" className="w-4 h-4 mr-2" id="terms" required />
