...
export function ProfileDownDown({ user }: { user: getUserProfileRes }) {
	...
	return (
		<div className="bg-background absolute top-11 right-0 z-30 w-64 rounded-md border-gray-800 text-white shadow-sm shadow-gray-700">
			<ul className="p-1">
				<DropDownItem className="" link={"/profile/user"}>
					<div className="items-center rounded-full bg-gray-500 p-1">
	...
	return (
		<div {...props}>
			<Link href={link}>
				<div
					className={
						"flex cursor-pointer items-center gap-2 rounded-sm px-4 py-2 hover:border-gray-600 hover:bg-gray-700"
					}
				>
					{children}
				</div>
